...
Ho imparato a lavorare con i modelli linguistici, e soprattutto a diffidarne: la loro affidabilità dipende dal compito assegnato. Buona parte della progettazione descritta in questa relazione consiste nel disegnare il sistema attorno a questa distinzione.

Ho conosciuto il semantic layer, che non avevo mai incontrato negli studi, e ne ho scritto i modelli. Definire una metrica si è rivelato meno meccanico di quanto pensassi. 

Ho lavorato con la comunicazione asincrona a code, e ho capito sul campo perché l'idempotenza non sia una raffinatezza teorica ma la conseguenza diretta di una garanzia di consegna.
